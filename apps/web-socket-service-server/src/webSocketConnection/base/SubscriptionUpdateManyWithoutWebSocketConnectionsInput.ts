...
@InputType()
class SubscriptionUpdateManyWithoutWebSocketConnectionsInput {
...
export { SubscriptionUpdateManyWithoutWebSocketConnectionsInput as SubscriptionUpdateManyWithoutWebSocketConnectionsInput };

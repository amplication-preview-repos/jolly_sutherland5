...
export class MessageResolverBase {
  ...
  async createMessage(
    ...
    return await this.service.createMessage({
      ...
      data: {
        ...
        webSocketConnection: args.data.webSocketConnection
          ? {
              connect: args.data.webSocketConnection,
            }
          : undefined,
      },
    });
  ...
  async getWebSocketConnection(
    ...
    const result = await this.service.getWebSocketConnection(parent.id);
